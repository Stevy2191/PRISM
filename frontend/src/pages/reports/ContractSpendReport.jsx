...
export default function ContractSpendReport({ filters, onForbidden }) {
  ...
  useEffect(() => {
    ...
    api.get('/reports/contracts/spend', { params })
  ...
  return (
    <div className="space-y-5">
      <div className="grid grid-cols-2 gap-4 lg:grid-cols-3">
        <StatCard label="Total contract spend" value={`$${data.summary.totalAnnualCost.toLocaleString()}`} />
